<div id="sidebar">
	...
	$productuser=array('users.php');
	$productorders=array('orders.php');
	$setting=array('settings.php');
    ...
    ?>
			...
			<div id="profile-links">
				Hello, <a href="#" title="Edit your profile">Shivendra Singh</a>, you have <a href="#messages" rel="modal" title="3 Messages">3 Messages</a><br />
				<br />
...
<li><a <?php if($filename=='products.php'): ?> class="current"<?php endif; ?> href="products.php">Manage Product</a></li> <!-- Add class "current" to sub menu items also -->
				...
				<li>
					<a href="#" class="nav-top-item <?php if(in_array($filename,$productuser)): ?>current<?php endif; ?> ">
						Users
					</a>
					<ul>
				...
				<li>
					<a href="#" class="nav-top-item <?php if(in_array($filename,$productorders)): ?>current<?php endif; ?>">
						Orders
					</a>
					<ul>
				...
				<li>
					<a href="#" class="nav-top-item <?php if(in_array($filename,$setting)): ?>current<?php endif; ?> ">
						Settings
					</a>
					<ul>
						<li><a <?php if($filename=='settings.php'): ?> class="current"<?php endif; ?> href="settings.php">General</a></li>
