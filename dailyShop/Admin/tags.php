                ...
                if ($conn->connect_error) {
				 ...
				 if (mysqli_num_rows($result) > 0) {
				   ...
				   while($row = mysqli_fetch_assoc($result)) {
									...
									<td>
										<!-- Icons -->
					    <a href="edittags.php?id='.$row["id"].'" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
					    <a href="deletetags.php?id='.$row["id"].'"  title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a> 
