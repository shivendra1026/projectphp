...
{                  $sql =  "SELECT * FROM products";
               ...
               if($_GET['id']==$row['id']){
                 ...
                 $total=$price*1;
                 $sql = "INSERT INTO cart (`id`,`image`,`name`,`price`,`quantity`,`total`)
                 VALUES ('$id','$image','$name','$price',1,'$total')";
...
?> <?php    echo 
                      '<tr>
                        <td><a class="remove" href="deleteitem.php?id='.$row['id'].'"><fa class="fa fa-close"></fa></a></td>
                              <td><a href="#"><img src="admin/image/'.$row["image"].'" alt="img"></a></td>
