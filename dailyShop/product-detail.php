...
?>
      <?php
                 if(isset($_GET['id'])){
                   $dtl=$_GET['id'];
                $sql = "SELECT * FROM products WHERE id=$dtl";
  ...
  <?php echo '<image src="admin/image/' . $row['image'] . '" height="300" width="250" alt="fashion img">'; ?>
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">                              
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      ...
                      <?php echo '<div class="simpleLens-big-image-container"><a data-lens-image="admin/image/'.$row['image'].'" class="simpleLens-lens-image">  <image src="admin/image/' . $row['image'] . '" height="300" width="250" alt="fashion img"  class="simpleLens-big-image">'; ?> </a></div>
                      </div>
